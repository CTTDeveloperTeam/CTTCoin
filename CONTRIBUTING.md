Contributing to CryptoInvest Core
============================

The CryptoInvest Core project operates an open contributor model where anyone is
...
The following applies to code changes to the CryptoInvest Core project, and is not to be
confused with overall CryptoInvest Network Protocol consensus changes.

Whether a pull request is merged into CryptoInvest Core rests with the project merge
...
Patches that change CryptoInvest consensus rules are considerably more involved than
...
Where a patch set proposes to change the CryptoInvest consensus, it must have been
...
The project leader is the release manager for each CryptoInvest Core release.
