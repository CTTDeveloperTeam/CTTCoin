...
This means one can have an always-on cryptoinvestd instance running, and another local cryptoinvestd/cryptoinvest-qt instance which connects to this node and receives blocks from it.
