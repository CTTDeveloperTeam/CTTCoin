...
#if defined(NDEBUG)
#error "CryptoInvest cannot be compiled without assertions."
#endif
...
int64_t GetBlockValue(int nHeight)
{
    ...
    nSubsidy = 6.5 * COIN;                      
	} else if (nHeight <= 300000 && nHeight > 2900000) {
    nSubsidy = 6.2 * COIN;
    ...
    if (nMoneySupply + nSubsidy >= 30000000 * COIN)
        nSubsidy = 30000000 - nMoneySupply;

    if (nMoneySupply >= 30000000 * COIN)
	nSubsidy = 0;
...
{
    RenameThread("cryptoinvest-scriptch");
