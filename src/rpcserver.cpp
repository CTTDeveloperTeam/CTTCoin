...
Value stop(const Array& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw runtime_error(
            "stop\n"
            "\nStop CryptoInvest server.");
    // Shutdown will take long enough that the response should get back
    StartShutdown();
    return "CryptoInvest server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* CryptoInvest features */
        {"cryptoinvest", "masternode", &masternode, true, true, false},
        {"cryptoinvest", "masternodelist", &masternodelist, true, true, false},
        {"cryptoinvest", "mnbudget", &mnbudget, true, true, false},
        {"cryptoinvest", "mnbudgetvoteraw", &mnbudgetvoteraw, true, true, false},
        {"cryptoinvest", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"cryptoinvest", "mnsync", &mnsync, true, true, false},
        {"cryptoinvest", "spork", &spork, true, true, false},
#ifdef ENABLE_WALLET
        {"cryptoinvest", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use cryptoinvestd, or the -server option to cryptoinvest-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> cryptoinvest-cli " + methodname + " " + args + "\n";
}
