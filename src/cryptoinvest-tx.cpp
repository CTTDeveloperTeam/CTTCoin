...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("CryptoInvest Core cryptoinvest-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  cryptoinvest-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded cryptoinvest transaction") + "\n" +
                               "  cryptoinvest-tx [options] -create [commands]   " + _("Create hex-encoded cryptoinvest transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded cryptoinvest transaction
