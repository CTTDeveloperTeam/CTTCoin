...
/** Utility functions used by the CryptoInvest Qt UI.
 */
namespace GUIUtil
{
...
// Render CryptoInvest addresses in monospace font
...
// Parse "cryptoinvest:" URI into recipient object, return true on successful parsing
