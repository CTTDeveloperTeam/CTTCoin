                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("CryptoInvest Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a CryptoInvest address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and cryptoinvest: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About CryptoInvest Core"), this);
    aboutAction->setStatusTip(tr("Show information about CryptoInvest Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for CryptoInvest"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your CryptoInvest addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified CryptoInvest addresses"));
    ...
    openAction->setStatusTip(tr("Open a CryptoInvest: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the CryptoInvest Core help message to get a list with possible CryptoInvest command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("CryptoInvest Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to CryptoInvest network", "", count));
}
...
{
    QString strTitle = tr("CryptoInvest Core"); // default title
