...
void Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("CryptoInvest Core"),
     ...
     * override -datadir in the cryptoinvest.conf file in the default data directory
     * (to be consistent with cryptoinvestd behavior)
     */
    if (dataDir != getDefaultDataDirectory())
