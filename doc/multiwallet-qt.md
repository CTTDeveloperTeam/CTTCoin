...
In order to support loading of multiple wallets in cryptoinvest-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is cryptoinvest.cpp.
...
Changes to cryptoinvest.cpp
----------------------
cryptoinvest.cpp is the entry point into cryptoinvest-qt, and as such, will require some minor modifications to provide hooks for
