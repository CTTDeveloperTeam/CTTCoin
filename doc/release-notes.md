CryptoInvest Core version 2.2.1 is now available from:

  <https://github.com/cryptoinvest-project/cryptoinvest/releases>
...
Please report bugs using the issue tracker at github:
  ...
  <https://github.com/cryptoinvest-project/cryptoinvest/issues>

Compatibility
==============

CryptoInvest Core is extensively tested on multiple operating systems using
...
CryptoInvest Core should also work on most other Unix-like systems but is not
...
of Bitcoin that CryptoInvest was forked from.
...
As well as everyone that helped translating on [Transifex](https://www.transifex.com/projects/p/cryptoinvest-project-translations/).
